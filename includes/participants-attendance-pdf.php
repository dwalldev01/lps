...
$strdata .="<tr align='center' ><td  colspan=$row style=background-color:#D5C9BB;font-size:16px;><strong>Participants  Attendance</strong></td></tr>";
...
$dompdf = new DOMPDF();
	...
	$time=time();
  $dompdf->stream("participants_attendance_report_".$courseid."_".$time.".pdf", array("Attachment" => true));
