...
/////// Cdoe Starts for Creating Email Template List ////////
   ...
   <?php if($template_id=="new") { ?> 
    <h1><?php _e("<i>Add Email Template</i>",'lps_wp'); ?></h1>
   <?php }else { ?>
   <h1><?php _e("<i>Update Email Template</i>",'lps_wp'); ?></h1>
   <?php } ?>
          ...
          <div id="titlediv">
		   ...
		   <table class="form-table">
		    ...
		    <table class="form-table">
					...
					<?php $templatelink = admin_url()."?action=viewtemplate&id=".$template_id; ?>
					<a href="<?php _e($templatelink);?>" target="_blank" class="button-primary"><?php _e("Preview Template"); ?></a>
                        </td>
                    </tr>
               </table>
  ...
  <table class="form-table">
                    <tr>
                     <th scope="row"><label for="payment_method"><?php _e("Email Tags* :",'lps_wp'); ?></label>
                        </th>
                        <td>
                  <?php _e(nl2br($email_help));?>
	...
	?>
	<div class="wrap">
	  <h1><?php _e("<i>Email Template Manager</i>",'lps_wp'); ?></h1>
